...
export default function Footer() {
  return (
    <footer className="bg-slate-900 border-t-2 border-blue-800 flex-shrink-0">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-10 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          {socialLinks.map((s) => {
            ...
            return (
              <a
                ...
                aria-label={s.name}
                className="bg-blue-700 hover:bg-blue-600 text-white p-2 rounded-full transition-colors"
              >
