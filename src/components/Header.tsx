...
export default function Header({ onRewardsClick }: Props) {
  return (
    <header className="bg-gradient-to-r from-blue-950 via-blue-900 to-slate-900 border-b-4 border-cyan-500 flex-shrink-0">
      <div className="max-w-screen-2xl mx-auto px-3 sm:px-4 md:px-8 py-2.5 md:py-4 pt-[max(0.625rem,env(safe-area-inset-top))] flex items-center gap-2.5 sm:gap-4">
        {/* Logo */}
        <img
          src={logo}
          alt="GMO Lavandería"
        ...
        {onRewardsClick && (
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-amber-400 to-yellow-400 hover:from-amber-300 hover:to-yellow-300 text-slate-900 font-black text-sm md:text-xl px-3 sm:px-4 md:px-7 py-2 md:py-3 rounded-xl sm:rounded-2xl shadow-lg transition-all sm:hover:scale-105 active:scale-95 border-2 border-yellow-200 whitespace-nowrap shrink-0"
          >
